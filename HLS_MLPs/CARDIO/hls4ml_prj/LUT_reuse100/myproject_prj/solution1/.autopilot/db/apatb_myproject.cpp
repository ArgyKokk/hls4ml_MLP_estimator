...
extern "C" void myproject_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *);
...
__xlx_tmp_lv.range(167,128) = ((long long*)__xlx_apatb_param_fc1_input)[0*2+2];
