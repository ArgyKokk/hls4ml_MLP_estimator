...
struct config2 : nnet::dense_config {
    static const unsigned n_in = 561;
    static const unsigned n_out = 20;
    static const unsigned io_type = nnet::io_parallel;
    static const unsigned strategy = nnet::latency;
    static const unsigned reuse_factor = 100;
    static const unsigned n_zeros = 4381;
    static const unsigned n_nonzeros = 6839;
...
struct config5 : nnet::dense_config {
    ...
    static const unsigned n_nonzeros = 808;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
...
struct config8 : nnet::dense_config {
    ...
    static const unsigned strategy = nnet::latency;
    static const unsigned reuse_factor = 100;
    static const unsigned n_zeros = 2130;
    static const unsigned n_nonzeros = 1966;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
...
struct config11 : nnet::dense_config {
    ...
    static const unsigned n_nonzeros = 298;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
