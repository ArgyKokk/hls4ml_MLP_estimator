...
void myproject(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<weight2_t, 11220>(w2, "w2.txt");
        nnet::load_weights_from_txt<bias2_t, 20>(b2, "b2.txt");
        nnet::load_weights_from_txt<weight5_t, 1280>(w5, "w5.txt");
        nnet::load_weights_from_txt<bias5_t, 64>(b5, "b5.txt");
        nnet::load_weights_from_txt<weight8_t, 4096>(w8, "w8.txt");
        nnet::load_weights_from_txt<bias8_t, 64>(b8, "b8.txt");
        nnet::load_weights_from_txt<weight11_t, 384>(w11, "w11.txt");
        nnet::load_weights_from_txt<bias11_t, 6>(b11, "b11.txt");
        loaded_weights = true;
    }
#endif
