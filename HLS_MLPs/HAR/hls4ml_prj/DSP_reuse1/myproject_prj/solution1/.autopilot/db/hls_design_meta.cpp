...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("fc1_input", 4488, hls_in, 0, "ap_none", "in_data", 1),
	...
	Port_Property("layer13_out_5", 16, hls_out, 6, "ap_vld", "out_data", 1),
	Port_Property("layer13_out_5_ap_vld", 1, hls_out, 6, "ap_vld", "out_vld", 1),
};
